...
--// USER KEY
local key = getgenv().script_key or _G.script_key
if not key then
...
if not decodeSuccess or not data or not data.valid then
    Players.LocalPlayer:Kick("[PaidGrade] Invalid or expired key")
    return
end
